            ...
            return (
              <div key={field.key} className="flex items-center gap-3">
                ...
                <div className="flex flex-1 min-w-0 items-center gap-2">
                  ...
                  {(showTeleowsLink || showConnectScanLink) && (
                    
                      href={showTeleowsLink ? "https://100s-sg.teleows.com" : "https://10.64.239.95/ConnectScan/login"}
                      target="_blank"
                      rel="noopener noreferrer"
                      title={showTeleowsLink ? "Open TeleOWS to get the OSSPA number" : "Open ConnectScan login"}
                      className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md border border-ink-600 text-gray-400 hover:border-gold/50 hover:text-gold transition-colors"
                    >
